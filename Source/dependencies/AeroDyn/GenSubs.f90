...
! Beddoes arrays
   IF (P%Dstall) THEN
      ...
      !!!!!..............
      !! Umass WInDS
      IF (.NOT. ALLOCATED(O%Beddoes%StallAngle)) ALLOCATE ( O%Beddoes%StallAngle(NELM,MAXTABLE) , STAT=Sttus )
      IF ( Sttus /= 0 ) CALL ProgAbort ( ' Error allocating memory for StallAngle array.' )
      O%Beddoes%StallAngle = 0.0_ReKi
      !! Umass WInDS         
      !!!!!..............
