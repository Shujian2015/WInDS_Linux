...
SUBROUTINE BiotSavart_Treecode(fila_x, fila_y, fila_z, points, GAMMA_array, RC_array, Uind_array,  &
                               theta, order, maxparnode, dist_tol, delta, cores)
...
!....................................................................
   ...
   REAL(DbKi), INTENT(IN   )                        :: theta, dist_tol, delta 
   INTEGER(IntKi),  INTENT(IN   )                   :: cores, order, maxparnode
...
! local variables
   ...
   ! set global variables to track tree levels during construction
      ...
      IF (cores > 0 .AND. cores < nthreads) THEN
          nthreads = cores
      END IF                             
